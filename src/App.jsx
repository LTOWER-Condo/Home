...
// --- ICONS (Replaced lucide-react with inline SVGs to fix load errors) ---
...
const PROJECT_HISTORY = [
  {
    ...
    description: "Our inaugural luxury high-rise project setting the standard for urban living."
  },
  {
    id: 2,
    ...
    link: "#ltower-2",
    location: "Toul Tom Poung, Phnom Penh, Cambodia",
    description: "An architectural marvel blending modern design with unparalleled amenities."
  },
  {
    id: 3,
    ...
    link: "#ltower-3",
    location: "Monivong Boulevard, Phnom Penh, Cambodia",
    description: "A landmark development offering premium urban lifestyle and convenience."
  },
  {
    id: 4,
    ...
    link: "#monivong-2",
    location: "Monivong Boulevard, Phnom Penh, Cambodia",
    description: "The pinnacle of our vision, featuring exclusive 2-floor duplex units."
  }
];
    ...
    <div className="animate-in fade-in duration-700">
      <section className="relative h-[60vh] min-h-[500px] flex flex-col items-center justify-center overflow-hidden">
        ...
        <div className="relative z-10 text-center px-6 max-w-4xl mx-auto mt-10">
          <div className="w-20 h-20 mx-auto bg-[#34220a] rounded-full flex items-center justify-center mb-6 shadow-[0_0_30px_rgba(255,150,68,0.2)]">
            <span className="text-[#FF9644] text-2xl font-bold">{project.id}</span>
          </div>
          <h1 className="text-4xl md:text-6xl font-semibold text-white mb-4">{project.title}</h1>
          <div className="flex items-center justify-center space-x-3 mb-6">
            <span className="text-[#FF9644] uppercase tracking-widest text-sm">Established {project.year}</span>
            <span className="text-gray-500">•</span>
            <span className={`text-sm uppercase tracking-widest ${project.status === 'Now Selling' ? 'text-[#FF9644] font-bold' : 'text-gray-400'}`}>{project.status}</span>
          </div>
          <p className="text-gray-200 text-lg md:text-xl max-w-2xl mx-auto mb-10 leading-relaxed">
            {project.description}
          </p>
          
          <div className="inline-flex items-center bg-[#34220a]/80 backdrop-blur-md px-6 py-3 rounded-sm border border-white/10">
            <MapPin className="w-5 h-5 mr-3 text-[#FF9644]" />
            <span className="text-white font-medium tracking-wide">{project.location}</span>
          </div>
        </div>
      </section>
